      ...
      {user ? (
        <div className="relative group cursor-pointer py-4 flex flex-col justify-center">
          ...
          >
            ...
            <div className="sm:hidden bg-neutral-100 p-2.5 rounded-full hover:bg-store-navy text-store-navy hover:text-white transition-all">
        ...
        >
          ...
          <div className="sm:hidden bg-neutral-100 p-2.5 rounded-full group-hover:bg-store-navy text-store-navy group-hover:text-white transition-all">
            <IconUser className="h-4 w-4" />
          </div>
        </Link>
      )}
